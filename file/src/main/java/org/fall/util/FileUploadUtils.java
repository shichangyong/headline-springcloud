...
import org.fall.config.WebConfig; //这个是导入上面的WebConfig.java配置文件
...
public class FileUploadUtils {
     ...
     * @param file    上传的文件
     * @param fileName    上传的子目录
     * @return 文件名称
     * @throws IOException
     */
    public static final String uploadFile(String baseDir, MultipartFile file, String fileName) throws IOException {
        try {
